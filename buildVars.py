...
addon_info = {
	...
	"addon_name": "addonsTools",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Tools for managing add-ons"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""Set of tools to manage add-ons not available on NVDA add-ons store:
	...
	* Add-ons documentation: allow to open the documentation file.
	...
	"addon_sourceURL": "https://github.com/ruifontes/addonsTools",
...
pythonSources = ["addon/*.py", "addon/globalPlugins/addonsTools/*.py"]
